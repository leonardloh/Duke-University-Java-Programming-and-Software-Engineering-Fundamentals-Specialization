...
//		earthquakesURL = "test2.atom";
	...
	private boolean isLand(PointFeature earthquake) {
		...
		for (Marker m : countryMarkers) {
			...
			{
				m.setLocation(earthquake.location);
				return true;
			}
		}
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) {
			...
			HashMap<String, Integer> countryMapCounters = new HashMap<String, Integer>();
			...
			for(Marker qm : quakeMarkers) {
				...
				if (em.isOnLand())
				{
					...
					if(! countryMapCounters.containsKey(country))
					{
						countryMapCounters.put(country,1);
					}
					else
					{
						countryMapCounters.put(country,countryMapCounters.get(country)+1);
					}
			...
			for(String namec : countryMapCounters.keySet())
			{
				System.out.println(namec + " : " + countryMapCounters.get(namec));
			}
	...
	public static void main(String[] args) {
		PApplet.main("Course4.w2.module4.EarthquakeCityMap");
	}
